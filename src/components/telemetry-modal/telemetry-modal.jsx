...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve DigitalCoDeBlock',
        description: 'DigitalCoDeBlock telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The DigitalCoDeBlock Team is always looking to better understand how DigitalCoDeBlock is used around the ' +
            'world. To help support this effort, you can allow DigitalCoDeBlock to automatically send usage information to ' +
            'the DigitalCoDeBlock Team.',
