                    ...
                    <p>
                        { /* eslint-disable max-len */ }
                        {
                            props.error ? <FormattedMessage
                                defaultMessage="We are very sorry, but it looks like you are using a browser version that DigitalCoDeBlock does not support. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari. "
                            ...
                            /> : <FormattedMessage
                                defaultMessage="We are very sorry, but DigitalCoDeBlock does not support this browser. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari."
                            ...
                            values={{
                                previewFaqLink: (
                                    ...
                                    >
                                        <FormattedMessage
                                            defaultMessage="FAQ"
                                            description="link to DigitalCoDeBlock FAQ page"
