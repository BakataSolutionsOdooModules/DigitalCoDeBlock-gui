...
class Blocks extends React.Component {
    ...
    handleScratchExtensionAdded (extensionInfo) {
        ...
        categoryInfoArray.forEach(categoryInfo => {
            ...
            // digitalcodeblock-blocks implements a menu or custom field as a special kind of block ("shadow" block)
     ...
     * to the variable validation prompt callback used in digitalcodeblock-blocks.
     */
